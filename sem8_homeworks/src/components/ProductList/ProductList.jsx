...
export const ProductList = (props) => {
    ...
    const setViewOption = () => {
        ...
        if (props.filter && props.filter.length > 0) {
            results = results.filter(product => new Set(product.availableSize).intersection(new Set(props.filter)).size > 0)
        }
        if (props.sorting != null) {
            if (props.sorting) {
                results.sort((pr1, pr2) => pr1.cost - pr2.cost)
            } else {
                results.sort((pr1, pr2) => pr2.cost - pr1.cost)
            }
        }
        return results
    }
    ...
    return <>
        ...
        <div className="products-box">
            {setViewOption().slice(0, props.countItem || 9).map(product => {
                return <div className="product_box" key={product.id}>
                    <div className="product__image_layout">
                        <img className="product__image" src={product.image} alt="product1" />
                        <div className="product__to_cart">
                            <div className="product__btn-to-cart-layout">
                                <button className="product__btn-to-cart" onClick={() => dispatch(addToCart(product))}>
                    ...
                    <div className="product__content">
                        ...
                        <p className="product__price">${product.cost.toFixed(2)}</p>
                    </div>
                </div>
            })}
        </div>
